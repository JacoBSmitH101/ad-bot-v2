...
/**
 * Discord slash command: /admin-stats
 * Admin-only command to view statistics for any player.
 * Can optionally specify a player, otherwise shows stats for the admin.
 * @module commands/admin-stats
 */

export const data = new SlashCommandBuilder()
    .setName("admin-stats")
    .setDescription("[ADMIN] View statistics for any player")
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
    .addUserOption((opt) =>
        opt
            .setName("player")
            .setDescription("Player to view stats for (leave empty for yourself)")
            .setRequired(false)
    );
...
/**
 * Execute the /admin-stats command.
